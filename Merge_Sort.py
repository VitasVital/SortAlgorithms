...
# v=Merge_sort()
# random_list_of_nums = v.merge_sort(random_list_of_nums)
# print(random_list_of_nums)
#
# random_list_of_text = v.merge_sort(random_list_of_text)
# print(random_list_of_text)
#
# random_list_of_date = v.merge_sort(random_list_of_date)
